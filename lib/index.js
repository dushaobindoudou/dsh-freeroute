...
class FreerouteRemote extends TypertRemoteService {
  ...
  async restoreUpstream(request) { return this._rpc['freeroute.restore-upstream'](request || {}) }
...
for (const m of ['state', 'setKey', 'clearKey', 'applyPatch', 'removeUpstream', 'restoreUpstream', 'catalogSync', 'probe', 'test', 'setDefault', 'getKeys']) markRemoteMethod(FreerouteRemote.prototype, m)
