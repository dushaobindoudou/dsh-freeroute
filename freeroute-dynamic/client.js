const CSS = [
  ...
  '.frp-warn { color: var(--dsw-alias-state-warning-primary, #fbbf24); font-size: 12px; white-space: pre-wrap; word-break: break-all; }',
  ...
  '.frp-keyrow { display: flex; gap: 8px; align-items: stretch; }',
  '.frp-keyrow .frp-input { flex: 1; min-width: 0; width: auto; box-sizing: border-box; }',
  '.frp-keytoggle { flex: none; align-self: flex-start; margin-top: 1px; }',
  ...
  ".frp-slider:after { content: ''; position: absolute; width: 13px; height: 13px; border-radius: 50%; top: 2px; left: 2px; background: var(--dsw-alias-bg-layer-inset, #fff); transition: transform .15s; box-shadow: 0 1px 2px rgba(0,0,0,.3); }",
